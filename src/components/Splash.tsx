...
const Splash: React.FC = () => {
  ...
  return (
    <div className="bg-mitosite-beige border-b border-mitosite-beige-dark">
      <div className="flex flex-col md:flex-row">
        {/* Content section - full width on mobile, half width on desktop */}
        <div className="w-full md:w-1/2 flex justify-center items-center">
          <div className="p-6 max-w-lg">
            <h1 className="font-cardo text-4xl md:text-5xl font-bold text-mitosite-beige-dark mb-8 leading-snug md:leading-snug">
              <span
            ...
            >
              <p className="font-josefin text-mitosite-beige-dark text-lg md:text-xl max-w-lg mb-8">
                Join the SAAS startups launching high converting, self-evolving
                websites with Mitosite AI
              </p>
        ...
        {/* Browser mockup - full width on mobile, half width on desktop */}
        <div className="w-full md:w-1/2 border-t md:border-t-0 md:border-l border-mitosite-beige-dark">
          <div className="grid grid-cols-2 max-h-screen bg-mitosite-beige">
            {/* Left Column */}
            ...
            <div className="flex flex-col border-l border-mitosite-beige-dark">
              ...
              <div className="flex justify-between px-4 py-3 border-b border-mitosite-beige-dark">
                <motion.div
                  ...
                  className="text-sm font-medium text-mitosite-beige-dark"
                >
                  MENU
                </motion.div>
                <motion.div
              ...
              >
                ...
                >
                  <div className="">CLEAR VALUE PROP</div>
                  <div>✳✳✳</div>
                </motion.div>
      ...
      <div className="bg-mitosite-beige-dark border-t border-mitosite-beige-dark">
        <Companies />
      </div>
    </div>
  );
